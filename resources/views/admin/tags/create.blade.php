        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('blue_factory.tags.fields.title').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('slug', trans('blue_factory.tags.fields.slug').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('language_id', trans('blue_factory.tags.fields.language').'', ['class' => 'control-label']) !!}
