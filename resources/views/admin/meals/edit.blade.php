...
@section('content')
    ...
    {!! Form::model($meal, ['method' => 'PUT', 'route' => ['admin.meals.update', $meal->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('tag[]', $tags, old('tag') ? old('tag') : $meal->tag->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('tag'))
                        <p class="help-block">
                            {{ $errors->first('tag') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('tag','Sastojci*', ['class' => 'control-label']) !!}
                    {!! Form::select('ingredient[]', $ingredients, old('ingredient') ? old('ingredient') : $meal->ingredient->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']) !!}
                    <p class="help-block"></p>
