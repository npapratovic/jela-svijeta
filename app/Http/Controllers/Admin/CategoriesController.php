...
class CategoriesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $languages = \App\Language::get()->pluck('iso_label', 'id')->prepend(trans('blue_factory.qa_please_select'), '');$meals = \App\Meal::where('category_id', $id)->get();

        $category = Category::findOrFail($id);

        return view('admin.categories.show', compact('category', 'meals'));
    }
