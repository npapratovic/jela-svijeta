...
class TagsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $languages = \App\Language::get()->pluck('iso_label', 'id')->prepend(trans('blue_factory.qa_please_select'), '');$meals = \App\Meal::whereHas('tag',
        ...
        return view('admin.tags.show', compact('tag', 'meals'));
    }
